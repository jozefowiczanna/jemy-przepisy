      ...
      <div class="container">
        <div class="flex-row">
          <div class="col-2">
            ...
            <p class="section__para">Aby dodać lub polubić przepis, musisz się <a href="#" class="link">zalogować</a>. Jeśli jeszcze nie masz konta, <a href="#" class="link">zarejestruj się</a> - wystarczy login i hasło.</p>
